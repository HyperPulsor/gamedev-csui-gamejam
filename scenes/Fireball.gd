...
func _ready():
	...
	var intial_tween = create_tween().set_parallel(true)
	var final_speed = speed
	speed = speed/5.0
	intial_tween.tween_property(self, "speed", final_speed, 6).set_trans(Tween.TRANS_QUINT).set_ease(Tween.EASE_OUT)
	intial_tween.play()
